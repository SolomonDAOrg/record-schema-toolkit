...
/** @typedef {"fixed" | "auto" | "percent" | "max-content" | "max-content-padded"} WidthType */
 ...
 * @property {number} [minimumBodyRows=1] - Body rows kept with the initial header, limited by the table length and page capacity.
 ...
 * @property {string|number} [outerBorderColor] - Frame around each physical table fragment; falls back to borderColor.
 * @property {number} [uppercaseBaselineShift=0.1] - Downward shift in em when every nonempty cell contains uppercase text; zero disables.
 * @property {VerticalAlign} [verticalAlign]
...
/**
 * @typedef {Object} MarkdownEnvelopeStyle
 * @property {boolean} [enabled]
 * @property {string[]} [labels] - Leading paragraph labels without trailing colons; defaults to Status, Owner, Applies to and Related.
 * @property {number} [fontSize]
 * @property {number} [labelFontSize]
 * @property {number} [lineSpacing]
 * @property {number} [rowGap]
 * @property {number} [labelGap]
 * @property {number | BoxPadding} [padding]
 * @property {string} [labelColor]
 * @property {string} [valueColor]
 * @property {string | number} [backgroundColor]
 * @property {Pick<BorderStyle, "width" | "color">} [topRule]
 * @property {Pick<BorderStyle, "width" | "color">} [bottomRule]
 * @property {number} [spacingBefore]
 * @property {number} [spacingAfter]
 */

/**
 * @typedef {Object} FormFieldsStyle
 * @property {number} [fontSize] - Label and field font size in points.
 * @property {number} [rowHeight] - Minimum height per field in points.
 * @property {number} [fieldLabelWidth] - Minimum shared label-column width in points.
 * @property {number | BoxPadding} [padding]
 * @property {string | number} [backgroundColor]
 * @property {string | number} [borderColor]
 * @property {number} [borderWidth]
 ...
 * @property {Readonly<Record<string, string | number>>} [variables] - Packet variables take precedence over source variables.
...
/**
 * @typedef {Object} HeadingPageBreaks
 * @property {ReadonlyArray<1 | 2 | 3 | 4 | 5 | 6>} levels
 * @property {ReadonlyArray<string>} [excludeText] - Exact heading text excluded from page breaks.
 */

/**
 * @typedef {Object} ResolvedRenderConfig
 * @property {HeadingPageBreaks} [headingPageBreaks]
 * @property {ReadonlyArray<string>} [textVariables]
 ...
 * @property {import("../renderers/TwoPassPdfRenderer.mjs").PdfRendererConfig["directiveStyles"]} [directiveStyles]
 * @property {PageComposition} [pageComposition]
 * @property {import("../renderers/TwoPassPdfRenderer.mjs").PdfRendererConfig["pageNumbering"]} [pageNumbering]
 * @property {import("../../pdf/page-tracking/types.mjs").PageTrackingConfig} [pageTracking]
...
/**
 * @typedef {Object} LetterheadLogo
 * @property {boolean} [enabled] - Defaults to true when configured.
 * @property {string} [path] - Local SVG path; required when enabled.
 * @property {number} x
 * @property {number} top
 * @property {number} width - Bounding box width before scaling, in PDF points.
 * @property {number} height - Bounding box height before scaling, in PDF points.
 * @property {number} [scale] - Positive size multiplier; defaults to 1.
 * @property {number} [gap] - Gap before company text, in PDF points; defaults to 12.
 * @property {string[]} shiftSourceHeadings - Regions aligned beside the logo, retaining their right edges.
 */

/**
 * @typedef {Object} PageCompositionLayout
 * @property {'literal' | 'fields'} [placeholderMode]
 * @property {{ x: number; top: number; width: number; fontSize: number; color?: string }} [pagination]
 * @property {PageCompositionRegion[]} regions
 * @property {PageCompositionDecoration[]} [decorations]
 * @property {LetterheadLogo} [letterheadLogo]
 */

/** @typedef {PageCompositionLayout & ({ mode: 'fixed' } | { mode: 'first-page'; continuationHeading: string })} PageComposition */

/**
 * @typedef {Object} PageCompositionPartition
 * @property {ComposedSection} firstPage
 * @property {ComposedSection} continuation
 */

/**
 * @typedef {Object} PageCompositionSource
 * @property {string} heading
 * @property {BaseNode[]} nodes
 */
