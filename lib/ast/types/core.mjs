 ...
 * @typedef {"heading" | "paragraph" | "list" | "list-item" | "blockquote" | "code-block" | "horizontal-rule" | "image" | "link" | "inline-format"} ProseNodeType
 */
 ...
 * @property {TextStyle} [style]
 * @property {number} [height]
 * @property {VerticalAlign} [verticalAlign] - Vertical alignment within allocated space
 * @property {string} [title] - For title-block
 * @property {string} [conjunction] - For title-block
 * @property {string} [entityName] - For title-block
 * @property {number} [subtitleFontSize] - For title-block
 * @property {number} [entityFontSize] - For title-block
 *
 * // kv-block (key/value columns) support
 * @property {ReadonlyArray<{ label: string, value: string | VariableRef }>} [rows] - For kv-block
 * @property {"left" | "right"} [labelAlign] - For kv-block label column alignment
 * @property {"left" | "right"} [label_align] - Snake_case alias for labelAlign
 * @property {number} [columnGap] - For kv-block column gap in points
 * @property {number} [column_gap] - Snake_case alias for columnGap
 * @property {number} [lineSpacer] - For kv-block row spacing in points
 * @property {number} [line_spacer] - Snake_case alias for lineSpacer
 * @property {string} [separator] - For kv-block label/value separator (default ": ")
...
/**
 * @typedef {Object} ResolvedCoverElement
 * @property {CoverPageElement["type"]} type
 ...
 *
 * // kv-block (key/value columns) support
 * @property {ReadonlyArray<{ label: string, value: string }>} [rows] - For kv-block (values resolved to strings)
 * @property {"left" | "center" | "right"} [labelAlign] - For kv-block label column alignment
 * @property {number} [columnGap] - For kv-block column gap in points
 * @property {number} [lineSpacer] - For kv-block row spacing in points
 * @property {string} [separator] - For kv-block label/value separator (default ": ")
 */
