...
/**
 * Inline form-field node - leaf node representing an AcroForm field placeholder
 */
export class FormFieldNode extends BaseNode {
    /**
     ...
     * }} [data]
     */
    constructor(placeholderText, data = {}) {
        super("form-field", data);

        /** @type {string} */
        this.placeholderText = placeholderText;

        /** @type {"text" | "signature"} */
        this.fieldType = data.fieldType === "signature" ? "signature" : "text";

        /** @type {string} */
        this.rawText =
            typeof data.rawText === "string" && data.rawText.length > 0
                ? data.rawText
                : `[${placeholderText}]`;

        /** @type {string | undefined} */
        this.fieldNameKey =
            typeof data.fieldNameKey === "string" &&
            data.fieldNameKey.length > 0
                ? data.fieldNameKey
                : undefined;
        ...
        /** @type {string | undefined} */
        this.tooltip =
            typeof data.tooltip === "string" && data.tooltip.length > 0
                ? data.tooltip
                : undefined;

        /** @type {string | undefined} */
        this.value = typeof data.value === "string" ? data.value : undefined;

        /** @type {boolean | undefined} */
        this.readOnly =
            typeof data.readOnly === "boolean" ? data.readOnly : undefined;
        ...
        this.maxLength =
            ...
            Number.isFinite(data.maxLength)
                ? data.maxLength
                : undefined;
    }
    ...
    /** @override */
    isBlock() {
        return this.attrs.multiline === true;
    }
    ...
    /** @override */
    cloneShallow() {
        const clone = new FormFieldNode(this.placeholderText, {
            attrs: { ...this.attrs },
            keepRules: this.keepRules ? { ...this.keepRules } : undefined,
            textStyle: this.textStyle ? { ...this.textStyle } : undefined,
            boxStyle: this.boxStyle ? { ...this.boxStyle } : undefined,
            ...
            fieldNameKey: this.fieldNameKey,
            name: this.name,
    ...
    toJSON() {
        const obj = super.toJSON();
        obj.placeholderText = this.placeholderText;
        obj.fieldType = this.fieldType;
        obj.rawText = this.rawText;
        if (this.fieldNameKey) {
            obj.fieldNameKey = this.fieldNameKey;
        }
        if (this.name) {
            obj.name = this.name;
        }
 ...
 * @param {string} placeholderText
 * @param {BaseNodeData & { fieldType?: "text" | "signature", rawText?: string, fieldNameKey?: string, name?: string, tooltip?: string, value?: string, readOnly?: boolean, required?: boolean, maxLength?: number }} [data]
 * @returns {FormFieldNode}
 */
export function createFormField(placeholderText, data) {
    return new FormFieldNode(placeholderText, data);
}
