 ...
 * @typedef {import("../templates/types.mjs").TemplateContract} TemplateContract
 **/
...
/**
 * @typedef {Object} PolicyPackReference
 * @property {'formatting' | 'render'} type
 * @property {string} path
 */

/**
 * @typedef {Object} DocumentPoliciesConfig
 * @property {Array<PolicyPackReference | string>} [pack_paths] - Typed references; legacy strings identify formatting packs.
 */

/**
 * @typedef {Object} StructuredDocumentSchemaBinding
 ...
 * @property {{overlay_schema_paths?: string[]}} [meta_policies]
 * @property {BucketConfig[]} [buckets]
 * @property {RootConfig} [root]
 * @property {DocumentPoliciesConfig} [document_policies]
 * @property {StructuredDocumentSchemaBinding[]} [structured_document_schemas]
 */
 ...
 * @property {TemplateContract} [template]
 ...
 * @property {boolean} [require_primary_document]
 ...
 * @property {"lf" | "crlf"} [newlines]
 * @property {boolean} [trailing_whitespace]
 */
 ...
 * @property {string[]} [metadata_required_fields]
 * @property {string[]} [metadata_optional_fields]
 * @property {boolean} [soft_wrap_preferred]
 */
 ...
 * @property {Record<string, LineWidthProfile>} [line_width_profiles]
...
/**
 * @typedef {{type: "variable", name: string}} HeaderFooterVariable
 * @typedef {string | HeaderFooterVariable | ReadonlyArray<string | HeaderFooterVariable>} HeaderFooterContent
 * @typedef {Object} HeaderFooterElement
 * @property {HeaderFooterContent} content
 * @property {{font_size?: number, bold?: boolean, italic?: boolean, color?: string | number}} [style]
 */

/**
 * @typedef {Object} HeaderFooterConfig
 * @property {"header" | "footer"} location
 * @property {"all" | "first" | "not-first" | "last" | "not-last" | "odd" | "even" | "section-first" | "section-not-first" | ReadonlyArray<number>} pages
 * @property {{left?: HeaderFooterElement, center?: HeaderFooterElement, right?: HeaderFooterElement}} columns
 * @property {number} [height]
 * @property {number} [spacing]
 * @property {number} [priority]
 * @property {{width?: number, color?: string | number}} [border]
 */

/**
 * @typedef {Object} RulesetPageTracking
 * @property {boolean} [enabled]
 * @property {'code128-b'} [symbology]
 * @property {string} [identifier]
 * @property {number} [module_width]
 * @property {number} [bar_height]
 * @property {number} [quiet_zone_modules]
 * @property {number} [right_inset]
 * @property {number} [bottom_inset]
 * @property {boolean} [show_text]
...
/**
 * @typedef {Object} RulesetMarkdownEnvelopeStyle
 * @property {boolean} [enabled]
 * @property {string[]} [labels]
 * @property {number} [font_size]
 * @property {number} [label_font_size]
 * @property {number} [line_spacing]
 * @property {number} [row_gap]
 * @property {number} [label_gap]
 * @property {number | { top?: number; right?: number; bottom?: number; left?: number; x?: number; y?: number }} [padding]
 * @property {string} [label_color]
 * @property {string} [value_color]
 * @property {string | number} [background_color]
 * @property {{ width?: number; color?: string }} [top_rule]
 * @property {{ width?: number; color?: string }} [bottom_rule]
 ...
 * @property {RulesetMarkdownEnvelopeStyle} [markdown_envelope_style]
 * @property {RulesetRender["page_tracking"]} [page_tracking]
 * @property {RulesetRender["page_composition"]} [page_composition]
 * @property {RulesetRender["page_numbering"]} [page_numbering]
 * @property {RulesetRender["heading_styles"]} [heading_styles]
 * @property {RulesetRender["text_variables"]} [text_variables]
 * @property {RulesetRender["heading_page_breaks"]} [heading_page_breaks]
 * @property {string} format
 * @property {string} [page_size]
 * @property {string} [orientation]
 * @property {Metadata} [margins]
 * @property {Record<string, string>} [fonts]
 * @property {Record<string, unknown>} [embedded_fonts]
 * @property {Record<string, string>} [font_role_defaults]
...
/**
 * @typedef {"rule" | "page-break"} RulesetHorizontalRuleBehavior
 */

/**
 * @typedef {Object} RulesetHorizontalRule
 * @property {number} [width_factor]
 * @property {number} [thickness]
 * @property {number} [gray_value]
 * @property {number} [spacing_before]
 * @property {number} [spacing_after]
 * @property {RulesetHorizontalRuleBehavior} [behavior]
 */

/**
 * @typedef {Object} RulesetTableRender
 * @property {number} [font_size]
 * @property {number} [font_size_scale]
 * @property {number} [min_font_size]
 * @property {number} [max_font_size]
 * @property {boolean} [auto_shrink]
 * @property {number} [line_height]
 * @property {number} [cell_padding]
 * @property {number} [border_width]
 * @property {string | number} [border_color]
 * @property {string} [vertical_align]
 * @property {string} [cell_v_align]
 * @property {number} [line_height_scale]
 * @property {number} [line_spacing_scale]
 */

/**
 * @typedef {Object} RulesetInlineFormatting
 * @property {boolean} [enabled]
...
/**
 * @typedef {Object} RulesetSpacingRule
 * @property {string | string[] | null} [prev]
 * @property {string | string[] | null} [next]
 * @property {number} [em]
 * @property {number} [pt]
 * @property {number} [priority]
 */
...
/**
 * @typedef {Object} RulesetSpacingPolicy
 * @property {"cursor" | "ink"} [basis] - Cursor advances by default; ink gaps measure between rendered block edges.
 * @property {RulesetSpacingRule[]} [before_rules]
 */

/**
 * @typedef {Object} RulesetTocLevelStyle
 * @property {number} [font_size_scale]
 * @property {boolean} [bold]
 * @property {number} [indent]
 * @property {number} [spacing_after]
 * @property {number} [spacing_before]
 * @property {string} [leader_style]
 * @property {boolean} [show_page_number]
 */

/**
 * @typedef {Object} RulesetToc
 * @property {Object.<number, RulesetTocLevelStyle>} [level_styles]
 * @property {number[]} [levels]
 */

/**
 * @typedef {Object} RulesetPageCompositionRegion
 * @property {string} source_heading - Exact Markdown heading delimiting the source block.
 * @property {number} x
 * @property {number} top
 ...
 * @property {number} font_size
 * @property {number} [line_spacing]
 * @property {number} [paragraph_gap]
 * @property {string} [color]
 * @property {boolean} [bold]
 * @property {boolean} [show_heading]
 * @property {number} [heading_font_size]
 * @property {number} [heading_gap]
 * @property {string} [heading_color]
 */

/**
 * @typedef {Object} RulesetPageCompositionDecoration
 * @property {number} x
 * @property {number} top
 * @property {number} width
 * @property {number} height
...
/**
 * @typedef {Object} RulesetLetterheadLogo
 * @property {boolean} [enabled]
 * @property {string} [path] - Local SVG path relative to the render pack; required when enabled.
 * @property {number} x
 * @property {number} top
 * @property {number} width
 * @property {number} height
 * @property {number} [scale]
 * @property {number} [gap]
 * @property {string[]} shift_source_headings
 */

/**
 * @typedef {Object} RulesetPageCompositionLayout
 * @property {'literal' | 'fields'} [placeholder_mode]
 * @property {{ x: number; top: number; width: number; font_size: number; color?: string }} [pagination]
 * @property {RulesetPageCompositionRegion[]} regions
 * @property {RulesetPageCompositionDecoration[]} [decorations]
 * @property {RulesetLetterheadLogo} [letterhead_logo]
 */

/** @typedef {RulesetPageCompositionLayout & ({ mode: 'fixed' } | { mode: 'first-page'; continuation_heading: string })} RulesetPageComposition */

/**
 * Raw render config as it comes out of YAML/JSON pack files — all snake_case.
 * Mirrors the fields of ResolvedRenderConfig but before deepSnakeToCamel conversion.
 * Converted to ResolvedRenderConfig exactly once, at the renderer boundary.
 *
 * @typedef {Object} RulesetRender
 * @property {ReadonlyArray<string>} [text_variables]
 * @property {{levels: ReadonlyArray<1 | 2 | 3 | 4 | 5 | 6>; exclude_text?: ReadonlyArray<string>}} [heading_page_breaks]
 * @property {ReadonlyArray<HeaderFooterConfig>} [default_headers]
 * @property {ReadonlyArray<HeaderFooterConfig>} [default_footers]
 * @property {RulesetMarkdownEnvelopeStyle} [markdown_envelope_style]
 * @property {Record<string, number>} [heading_scales]
 * @property {RulesetPageComposition} [page_composition]
 * @property {{include_signing_page?: boolean}} [page_numbering]
 * @property {RulesetPageTracking} [page_tracking]
 * @property {Record<string, { color?: string; bold?: boolean; align?: 'left' | 'center' | 'right' }>} [heading_styles]
 * @property {string} [target]
 ...
 * @property {string} [page_size]
 * @property {string} [orientation]
 * @property {RulesetMargins} [margins]
 * @property {RulesetFonts} [fonts]
 * @property {Record<string, unknown>} [embedded_fonts]
 * @property {Record<string, string>} [font_role_defaults]
 * @property {number} [base_font_size]
 * @property {number} [title_font_size]
 * @property {number} [line_spacing]
 * @property {number} [paragraph_spacing_factor]
 * @property {RulesetSpacingPolicy} [spacing_policy]
 * @property {number} [list_indent_per_level]
 * @property {number} [code_block_indent]
 * @property {RulesetHorizontalRule} [horizontal_rule]
 * @property {RulesetTableRender} [table]
 * @property {RulesetTableRender} [table_style]
 * @property {RulesetInlineFormatting} [inline_formatting]
 * @property {RulesetToc} [toc]
 * @property {CoverRenderConfig} [cover_config]
 * @property {"always" | "part-only" | null} [break_mode]
 */
 ...
 * @property {Record<string, string>} [font_roles]
 */
 ...
 * @property {"text" | "title-block" | "image" | "spacer" | "rule" | "kv-block" | "box"} type
 ...
 * @property {string} [conjunction_color]
 * @property {string} [entity_color]
 * @property {string} [entity_name]
...
/**
 * @typedef {Object} DustCoverConfig
 * @property {boolean} [enabled]
 ...
 * @property {string[]} [allowed_font_hosts]
 * @property {boolean} [verbose]
 */

/**
 * @typedef {Object} DustCoverResolvedConfig
 * @property {boolean} enabled
 * @property {string | null} template
 * @property {string | null} path
 * @property {string | null} svg
 ...
 * @property {Metadata} [dust_cover_templates]
 * @property {DustCoverConfig} [dust_cover_config]
 * @property {DustCoverConfig} [dust_cover] - Alias for dust_cover_config
 * @property {Metadata} [packet_variants]
 ...
 * @property {CoverRenderConfig} cover_config
 * @property {Metadata} dust_cover_templates
 * @property {DustCoverResolvedConfig} dust_cover_config
 * @property {Metadata} packet_variants
 ...
 * @property {string | null} registry_path - First registry YAML path if found
 * @property {string[]} registry_paths - Registry YAML paths discovered
