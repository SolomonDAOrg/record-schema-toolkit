    ...
    getStructuredDocumentSchemas() {
        ...
        for (let i = 0, len = bindings.length; i < len; i++) {
            ...
            out.push({
                ...
                min_count: Number.isSafeInteger(binding.min_count) && binding.min_count >= 0 ? binding.min_count : null,
                max_count: Number.isSafeInteger(binding.max_count) && binding.max_count >= 1 ? binding.max_count : null
            });
        }
        return out;
    }
