...
/**
 * @typedef {import("./types/report.mjs").ReportSection} ReportSection
 * @typedef {import("./types/report.mjs").ReachSummaryRow} ReachSummaryRow
 */
 ...
 * @returns {{ data: import("./types/report.mjs").TableReportSection, text: string }}
 */
 ...
 * @param {Map<string, import("./types/general.mjs").AssertionRule>} rules
 * @param {Record<string, unknown>} section
 * @returns {{ data: import("./types/report.mjs").ReachCatalogueSection, text: string }}
 */
