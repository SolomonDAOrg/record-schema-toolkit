...
const DOC_TYPE_LEGACY = /^([A-Z]{2,5})(?:[-_])/;
...
export class CorpusIndex {
     ...
     * @param {"auto" | "yaml" | "json" | "text" | "none"} [parseMode]
    ...
    getUnit(file, parseMode = "auto") {
        ...
        const docTypeMatch =
            DOC_TYPE_PREFIXED.exec(stem) ?? DOC_TYPE_LEGACY.exec(stem);
