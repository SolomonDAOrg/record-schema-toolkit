...
export class CorpusIndex {
     ...
     */
    constructor(rootDirectory, contents = new Map()) {
        /** @type {ReadonlyMap<string, string>} */
        this._contents = new Map(contents);
        /** @type {string} */
    ...
    listFiles() {
        ...
        this._files = [...new Set([...found, ...this._contents.keys()])].sort();
        return this._files;
    }
    ...
    getUnit(file, parseMode = "auto") {
        ...
        let text = "";
        try {
            const override = this._contents.get(file);
            const raw = override === undefined ? readFileSync(join(this.root, file)) : Buffer.from(override, "utf8");
