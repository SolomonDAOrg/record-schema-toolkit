...
export { LanguageRuleRegistry } from "./record-schema/LanguageRuleRegistry.mjs";
...
export {
    ...
    LICENSE_RULE,
    LicenseDocument
} from "./record-schema/LicenseDocument.mjs";

export { LicenseRegistry } from "./record-schema/LicenseRegistry.mjs";

export { verifyLicenseRepository } from "./record-schema/LicenseVerification.mjs";

// language-rule application
export { LanguageRuleSetRepository } from "./language-rules/LanguageRuleSetRepository.mjs";

export { LanguageClassifier } from "./language-rules/LanguageClassifier.mjs";

export { ParserAdapterRegistry } from "./language-rules/ParserAdapterRegistry.mjs";

export { SourceFileScanner } from "./language-rules/SourceFileScanner.mjs";

export { LanguageRuleEngine } from "./language-rules/LanguageRuleEngine.mjs";
...
export {
    ...
    offsetToPosition,
    splitLines
} from "./language-rules/SourceText.mjs";
